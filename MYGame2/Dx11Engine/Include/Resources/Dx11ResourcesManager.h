...
private:
	unordered_multimap<string, class CDx11Mesh*>	m_mapMesh;
	unordered_multimap<string, class CDx11Texture*>	m_mapTexture;
	unordered_multimap<string, class CDx11Sampler*>	m_mapSampler;
