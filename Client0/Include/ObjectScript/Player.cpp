...
void CPlayer::CreateBar()
{
	...
	pTransform->SetWorldPos(50.f+100.f, g_tRS[eType].iHeight - 100.f, 0.f);
	...
	pTransform->SetWorldPos(47.5f + 100.f, g_tRS[eType].iHeight - 100.f, 0.f);
	SAFE_RELEASE(pTransform);
...
void CPlayer::CreatePlayeruUI()
{
	...
	pTransform->SetWorldPos(1110.f, g_tRS[eType].iHeight - 110.f, 0.f);
	SAFE_RELEASE(pTransform);
