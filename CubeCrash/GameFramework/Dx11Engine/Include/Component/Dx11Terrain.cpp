...
void CDx11Terrain::CreataTerrain(const string & strKey, 
	...
	wchar_t * pDiffuseTexName, char * pHeightName, 
...
//	//pMaterial->SetSpecularTexture("TerrainSpecular", L"Terrain\\RM_Ground_stone_S.png");
//	//pMaterial->SetNormalMapTexture("TerrainNormal", L"Terrain\\RM_Ground_stone_Ν.png");
