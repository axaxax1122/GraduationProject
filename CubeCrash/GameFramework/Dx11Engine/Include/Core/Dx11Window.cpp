...
bool CDx11Window::Init(wchar_t * pTitle, wchar_t * pClass, HINSTANCE hInst, int iIconID, int iSmallIconID, RESOLUTION_TYPE eRT, WNDPROC pProc)
{
	m_hInst = hInst;
...
ATOM CDx11Window::MyRegisterClass(HINSTANCE hInst, wchar_t * pClass, int iIconID, int iSmallIconID, WNDPROC pProc)
{
	WNDCLASSEXW wcex;
...
BOOL CDx11Window::InitInstance(wchar_t * pTitle, wchar_t * pClass, RESOLUTION_TYPE eRT)
{
