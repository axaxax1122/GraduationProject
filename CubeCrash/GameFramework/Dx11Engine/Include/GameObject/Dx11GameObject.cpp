...
void CDx11GameObject::ClearStateFlag()
{
	m_iStateFlag = STATE_NONE;
}

void CDx11GameObject::SetStateFlag(int iStateFlag)
{
	m_iStateFlag = iStateFlag;
}

void CDx11GameObject::AddStateFlag(int iStateFlag)
{
	m_iStateFlag |= iStateFlag;
}

void CDx11GameObject::DeleteStateFlag(int iStateFlag)
{
	m_iStateFlag ^= iStateFlag;
}
...
int CDx11GameObject::GetStateFlag() const
{
	return m_iStateFlag;
}

bool CDx11GameObject::GetControl() const
{
	return m_bControl;
}

void CDx11GameObject::SetControl(bool bControl)
{
	m_bControl = bControl;
}
...
size_t CDx11GameObject::GetComponentSize()
{
