...
bool CDx11Shader::LoadShader(wchar_t * pFileName, char * pEntry[ST_MAX], int iHighV,
...
bool CDx11Shader::LoadVertexShader(wchar_t * pFileName, char * pEntry, 
...
bool CDx11Shader::LoadPixelShader(wchar_t * pFileName, char * pEntry, int iHighV, int iLowV, const string & strPathKey)
{
	SAFE_RELEASE(m_pPSBlob);
	SAFE_RELEASE(m_pPS);
