...
public:
	...
	bool IsInFrustrum(class CDx11GameObject* pObj);
	void AddQuadTreeObj(class QuadTree* pNode);
	void AddQuadTree_DynamicObj(class QuadTree* pNode);
	void ClearQuadTree_DynamicObj(class QuadTree* pNode);
	void QuadTreeRenderEnable();
