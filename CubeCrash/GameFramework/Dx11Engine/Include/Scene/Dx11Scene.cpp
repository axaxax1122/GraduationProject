...
void CDx11Scene::CreateSky(const string & strTexKey, wchar_t * pFileName, const string & strPathKey)
{
	if (!m_pSky) 
	{
		...
		pTr->SetWorldScale(3000.f, 3000.f, 3000.f);
		SAFE_RELEASE(pTr);
	}
...
void CDx11Scene::AddSceneScript(CDx11Script * pScript, const string & strTag)
{
