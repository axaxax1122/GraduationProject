...
public:
	...
	bool LoadMesh(const string& strKey, wchar_t* pFileName, const string& strPathKey = MESH_PATH);
	bool LoadMesh(const string& strKey, wchar_t* pFileName, 
...
private:
	...
	bool LoadVertexData(const string & strPathKey);
	bool LoadMaterialData(const string& strKey);
	bool LoadMaterialData(const string& strKey, wchar_t* pTexName,
		const string& strPathKey);
	bool LoadAnimationData(const string & strPathKey);
};
