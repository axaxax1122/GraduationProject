...
public:
	bool LoadShader(wchar_t* pFileName, char* pEntry[ST_MAX], int iHighV, int iLowV,
...
private:
	bool LoadVertexShader(wchar_t* pFileName, char* pEntry, int iHighV, 
		int iLowV, const string& strPathKey);
	bool LoadPixelShader(wchar_t* pFileName, char* pEntry, int iHighV, 
		int iLowV, const string& strPathKey);
